...
Additionally, you will want to update `Model name` field at the Edit BREAD information. In case of `Page` we have to change `TCG\Voyager\Models\Page` to `App\Page` on the BREAD edit page to make the right extending hierarchy of the classes.
